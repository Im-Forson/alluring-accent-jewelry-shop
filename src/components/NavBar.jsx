        ...
        <div>
            ...
            <div class="flex flex-row items-center justify-between px-4 md:px-8 py-2">
                ...
                <div class="hidden md:flex flex-row items-center gap-10">
                    ...
                    <div className="">
                        <Link to={'/shop'} class={`${activePage=='shop'?'text-pink-600':'black'} cursor-pointer hover:text-pink-300`}
                            onClick={shopHandler}
                        >
                            Shop
                        </Link>
                    ...
                    <div className="">
                        <Link to={'/contact'} class={`${activePage=='contact'?'text-pink-600':'black'} cursor-pointer hover:text-pink-300`}
